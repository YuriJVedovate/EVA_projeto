...
insert into supermercado values('92864872000116', 'Carrefour', 'carrefour@administraçao.com.br', 'carrefouradm', '(11)5678-9876');
insert into supermercado values('96239176000170', 'Extra', 'extra@administraçao.com.br', 'extrasuporte', '(11)7654-9812');
insert into supermercado values('09592804000100', 'Pão de Açucar', 'paodeaçucar@geral.com.br', 'paoacucar123', '(21)6578-3489');
select * from supermercado;
delete from supermercado where cnpj = '96239176000170';
...
select * from usuario;
select supermercado.*, id_usuario, nome_user from supermercado, usuario where fkcnpj = cnpj;
...
select supermercado.*, idsensor, area_sensor from supermercado, sensores where fkcnpj = cnpj;
